...
const achievementsData: BilingualAchievement[] = [
  ...
  },
  {
    ...
    description: {
      th: "ผู้เข้ารอบสุดท้าย 22 ทีม ได้รับทุนสนับสนุนการพัฒนาจาก HealthTech X 2 The Future โดย ThaiHealth",
      en: "Finalist in the top 22 teams, received a fund for development from HealthTech X 2 The Future by ThaiHealth",
    },
    longDescription: {
      th: "ผู้เข้ารอบสุดท้ายใน 22 ทีมแรกของการแข่งขัน HealthTech X The Future ที่มีชื่อเสียง และได้รับทุนสนับสนุนการพัฒนาเพื่อยกระดับโซลูชันนวัตกรรมด้านเทคโนโลยีสุขภาพ การได้รับการยอมรับนี้แสดงให้เห็นถึงความทุ่มเท ความคิดสร้างสรรค์ และความสามารถของทีมในการส่งมอบไอเดียที่สร้างผลกระทบต่อการแก้ไขปัญหาเร่งด่วนในอุตสาหกรรมสุขภาพ ทุนสนับสนุนที่ได้รับเป็นเครื่องมือสำคัญในการสนับสนุนโครงการ ช่วยให้เราสามารถพัฒนาและปรับปรุงวิสัยทัศน์ของเราได้ต่อไป พร้อมทั้งเตรียมพร้อมที่จะสร้างคุณประโยชน์ที่มีความหมายต่อสาขานี้",
      en: "Finalist among the top 22 teams in the prestigious HealthTech X The Future competition, securing development funding to advance innovative solutions in healthcare technology. This recognition highlights our team's dedication, creativity, and ability to deliver impactful ideas that address pressing challenges in the healthcare industry. The funding provided has been instrumental in supporting our project, enabling us to further develop and refine our vision while positioning us to make a meaningful contribution to the field.",
    },
    date: "2024",
    icon: "💵",
    category: {
